...
export const GatewaySection = () => {
  return (
    <section className="relative py-24 bg-background border-y border-black/5 dark:border-white/5 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-[1440px]">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold font-display text-cyan-400 mb-6 tracking-tight">
